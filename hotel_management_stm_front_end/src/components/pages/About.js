...
<p className='p1'>Exceptional Service - We understand that the value can be created with every encounter and this is reflected in our superior standard of service.</p>

<p className='p1'>Integrity - We are honest and straightforward in our interactions with our owners, guests, colleagues and the communities in which we operate.</p>

<p className='p1'>Respect - We respect the objectives of our stakeholders, the values of our guests, and the cultural difference in the locations that we operate.</p>

<p className='p1'>Teamwork and Passion - We bring our individual expertise, creativity and passion for our industry as a Marco Polo team member.  This sets us apart and is the essence of the Marco Polo Way.</p>

<p className='p1'>Continuous Improvement - We are innovative and utilize best practices to continually improve our management techniques, and the quality of our products and services. </p>            
          ...
          <div className="row">
            ...
            <div className="col-md-4 text-center">
              ...
              <p>
                ...
                of contemporary society.Tradition is a testament to our success
                but in the future we also want to embrace the changes that
                modern time brings and become more attractive in the market and
            ...
            <div className="col-md-4 text-center">
              <h2>Our Mission</h2>
              <p>
                The mission of the Hotel Grand is to put hospitality services on
            ...
            <div className="col-md-4 text-center">
              <h2>Our Values</h2>
              <p>The Hotel Grand holds the following values and beliefs: </p>
              ...
              <p>
                ...
                member. This sets us apart and is the essence of the Marco Polo
                Way.
              </p>

              <p>
                Continuous Improvement - We are innovative and utilize best
                practices to continually improve our management techniques, and
