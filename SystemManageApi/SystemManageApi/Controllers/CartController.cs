...
namespace SystemManageApi.Controllers
{
    ...
    public class CartController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Cart>>> GetVehicles()
        {
            return await _context.Carts
                .Select(x => new Cart()
                {
                    ...
                    FoodsimageName = x.FoodsimageName,
                    FoodsimageSrc = String.Format("{0}://{1}{2}/Images2/{3}", Request.Scheme, Request.Host, Request.PathBase, x.FoodsimageName)
        ...
        public async Task<ActionResult<Cart>> DeleteCart(int id)
        {
            ...
            DeleteImage(cart.FoodsimageName);
